  ...
  render(root: HTMLElement): void {
    ...
    router
      .on('/', () => {
        ...
        content.append(
          new MainDashboard(
            new DashboardController(repo, converter, settings.displayCurrency),
            () => router.navigate('/input'),
      ...
      .on('/snapshots', () => {
        content.innerHTML = '';
        const ctrl = new SpreadsheetController(repo, converter, settings.displayCurrency);
        content.append(
      ...
      .on('/income', () => {
        content.innerHTML = '';
        content.append(new IncomePage(repo, converter, settings.displayCurrency).render());
